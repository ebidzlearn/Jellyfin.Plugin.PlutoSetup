...
- [x] Release ZIP exists: dist/plutotvautotuner_0.1.0.4.zip
- [x] Repository ZIP exists: repository/releases/plutotvautotuner_0.1.0.4.zip
...
- [x] Compiled assembly version matches project version: 0.1.0.4
...
- [x] Manifest version matches project and ZIP filename: 0.1.0.4
- [x] Manifest targetAbi is Jellyfin ABI 10.11.0.0
- [x] Manifest sourceUrl is absolute HTTP/HTTPS: https://ebidzlearn.github.io/Jellyfin.Plugin.PlutoSetup/releases/plutotvautotuner_0.1.0.4.zip
...
- [x] Manifest checksum matches final ZIP MD5: 43f155e162c3627df1f01e2f55375b24
