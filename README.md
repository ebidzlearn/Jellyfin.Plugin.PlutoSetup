...
- `dist/plutotvautotuner_0.1.0.4.zip`
- `repository/manifest.json`
- `repository/releases/plutotvautotuner_0.1.0.4.zip`
- `repository/images/pluto-tv-auto-tuner.png`
- `docs/manifest.json`
- `docs/releases/plutotvautotuner_0.1.0.4.zip`
...
3. Extract `dist/plutotvautotuner_0.1.0.4.zip` into that folder.
4. Start Jellyfin.
...
- `https://YOUR_HOST/YOUR_REPOSITORY_PATH/releases/plutotvautotuner_0.1.0.4.zip`
...
Install or update to `0.1.0.4` before uninstalling from Dashboard > Plugins. This version removes older Pluto TV Auto Tuner version folders during Jellyfin's uninstall callback so stale versions cannot reactivate after restart. After clicking Uninstall, restart Jellyfin to let Windows release the loaded plugin DLL and let Jellyfin finish deleting the active version folder.

If an older release was already uninstalled and a stale folder remains, stop Jellyfin and delete any `Pluto TV Auto Tuner_*` folders from the Jellyfin plugins folder.
...
5. Copy the generated URLs into Jellyfin Live TV manually.
...
- Auto-add is disabled in this MVP; manual setup is always supported.
